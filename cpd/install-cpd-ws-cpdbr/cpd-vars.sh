...
# this cpd-vars is provided as an example and has been adapted to my platform, please adapt it to your platform
...
export OCP_URL="https://api.<your-domain>:6443"
export OPENSHIFT_TYPE=aro
export IMAGE_ARCH=amd64
export OCP_USERNAME=cpdadmin
export OCP_PASSWORD="<my password>"
...
REGION=<your region>
# increment this value at each backup
TENANT_BACKUP_VERSION=2
TENANT_BACKUP_NAME=cpd-oadp-tenant-backup-${TENANT_BACKUP_VERSION}