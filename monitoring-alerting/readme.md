...
- You already have a central monitoring stack that support Prometheus format then [you should leverage the kasten remote write support](https://www.veeam.com/kb4797). You can also check this [excellent blog article on remote_write](https://veeamkasten.dev/observability-series-1-prometheus-remote-writes) 
